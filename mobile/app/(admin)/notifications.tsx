  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.topRow}>
        <View>
          <Text style={styles.title}>{t('admin.notifications.title')}</Text>
          <Text style={styles.subtitle}>{unread > 0 ? t('admin.notifications.unread', { count: unread }) : t('admin.notifications.allCaughtUp')}</Text>
        </View>
        {unread > 0 && (
      ...
      <FlatList
        ...
        ListEmptyComponent={<EmptyState icon="notifications-outline" title={t('admin.notifications.noNotifications')} />}
