...
import { TrendingUp, Eye, EyeOff, CheckCircle, Mail, RefreshCw, ArrowLeft } from "lucide-react";
          ...
          <div className="rounded-2xl bg-white shadow-2xl p-8 text-center">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button
                ...
                disabled={resending}
                className="flex items-center justify-center gap-2 rounded-xl border border-gray-200 px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50"
              >
    ...
    <div className="min-h-screen bg-gradient-to-br from-navy-950 via-navy-900 to-navy-800 flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-white/60">Join Investo and start growing your investments</p>
        </div>
                    ...
                    {strength.checks.map((c) => (
                      <li
                        ...
                        className={cn(
                          ...
                          c.passed ? "text-emerald-600" : "text-gray-400",
                        )}
                      >
                        <span className={cn(
                          "h-1.5 w-1.5 rounded-full flex-shrink-0",
                          c.passed ? "bg-emerald-500" : "bg-gray-300",
                        )} />
                        {c.label}
                      </li>
                    ))}
