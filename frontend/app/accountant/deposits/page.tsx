...
export default function AccountantDepositsPage() {
  ...
  const canConfirm = useHasPermission("confirmDeposits");
  const canReject = useHasPermission("rejectDeposits");
    ...
    <div className="space-y-6">
      ...
      {actionTarget && (
        <ConfirmRejectModal
          ...
          targetLabel={`deposit of ${formatCurrency(actionTarget.deposit.amount)} by ${actionTarget.deposit.fullName}`}
